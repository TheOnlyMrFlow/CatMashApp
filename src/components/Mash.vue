        ...
        <v-container grid-list-md fill-height>
            ...
            <v-layout row wrap fill-height align-center>
                 ...
                 <v-flex offset-sm2 sm4 xs12 text-xs-center>
                     ...
                     <transition
                    v-bind:name="picked == 1 ? 'chosen' : 'not-chosen'"
                    ...
                    >
                        ...
                        size=35vh
                        contain>
                            <img :src="catOne.image" alt="avatar">
                 ...
                 <v-flex sm4 xs12 text-xs-center>
                    ...
                    <transition
                    :name="picked == 2 ? 'chosen' : 'not-chosen'"
                    >
                        <v-avatar 
                            @click="pick(2)"
                            v-if="show"
                            ...
                            contain>
                                ...
                                <img :src="catTwo.image" alt="avatar">
